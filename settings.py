...
ADMINS = (
     ('Tim Miller', 'tim.miller@gmail.com'),
)
...
#STATIC_ROOT = '/anafora/src/static'
...
STATICFILES_DIRS = (
    ...
    '/anafora/src/static',
    '/anafora/src/static/css',
    '/anafora/src/static/js',
    '/anafora/src/static/image'
    )
